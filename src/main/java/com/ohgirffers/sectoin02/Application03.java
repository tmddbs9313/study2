package com.ohgirffers.sectoin02;
...
public class Application03 {
    public static void main(String[] args) {
        ...
        /*필기.
         *  깊은 복사는 heap 에 생성된 배열이 가지고있는 값을
    ...
    *  3. System 의 arraycopu() 를 이용한 복사
    *  4. Arrays 의 copyOf()를 이용한 복사
    *  이 중 가장 높은 성능을 보이는 것은 순수 배열의 복사를 위해 만들어진
    *  arraycopy() 메소드 이며, 가장 많이 사용되는 방식은 좀 더 유연한 방식인 copyOf() 메소드이다.
    * /
    /*필기. clone() 은 이전 배열과 같은 배열밖에 만들 수 없다는 특징을 가지고
    *  그 외 3가지 방법은 복사하는 배열의 길이를 마음대로 조절할 수 있다는 특징을 가진다.*/
        ...
        int[] copyArr1 = new int[10]; // 카피 알알에 오리진 알알을 복사.
        ...
        //원본배열과 복사한 값은 같은 값을 가지고 나머지 인덱스는 다른 값을 가짐.
        print(copyArr1);
        ...
        int[] copyArr4 = Arrays.copyOf(originArr, 7); //1~5까지 만드는데 두개 공간 더 만들어
