...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /*수업목표, 배열에 대해 이해하고 배열의 사용목적을 잏해할 수 있다.*/
        /*필기.
        *  배열이란?
        ...
        *  2. 반복문을 이용한 연속 처리가 불가능하다.*/
        ...
        /*필기. 하나의 이름으로 관리되는 연ㅇ속된 메모리 공간이고 , 공간마다 찾아갈 수 있는 번호 (인덱스)를 이용해 접근한다.*/
        arr[0] =10;
        arr[1] =20;
        arr[2] =30;
        arr[3] =40;
        ...
        *  참조형 변수라고 한다.*/
        ...
        /*필기. 배열을 할당할 시에는 반드시 배열의 크기를 지정해주어야한다.*/
        int [] iarr;
...
//        age[4] = 50;
        ...
        *  참조 : null*/
        ...
        /*필기.
        *  자바에서 지정한 기본값 외의 값으로 초기화 하고 싶으면 블럭({}) 을이용한다.
        *  블럭 ({})을 사용하는 경우에는 new를 사용하지않아도 되며,값의 갯수만큼 자동으로 크기가 설정된다*/
